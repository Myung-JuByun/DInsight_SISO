...
public class UserAdminController {
		...
		*//**
		 ...
		 * @exception Exception
		 *//*
		@RequestMapping(value = "/adm/userAdmin")
		public String userAdminHtml(HttpServletRequest request, ModelMap model) throws Exception {
			String pageUrl              = "/adm/userAdmin";
		 ...
		 @RequestMapping(value = "/adm/selectUserAdmin")
		 @ResponseBody
		 public void selectUserAdmin(Model model , HttpServletRequest request ,HttpServletResponse response ) throws Exception {
