...
import siso.cmmn.sso.service.SpringSSOService;
...
public class SpringSSOLoginFilter implements Filter{
	
	private FilterConfig config;
	
	protected final static Log LOG = LogFactory.getLog(SpringSSOLoginFilter.class);
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		SpringSSOService egovSSOService = null;
		try{
			egovSSOService = (SpringSSOService) act.getBean("egovSSOService");
