...
public class SpringSSOLogoutFilter implements Filter{
	private FilterConfig config;
	
	protected final static Log LOG = LogFactory.getLog(SpringSSOLogoutFilter.class);
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		SpringSSOService egovSSOService = (SpringSSOService) act.getBean("egovSSOService");
