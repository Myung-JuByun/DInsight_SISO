 ...
 * <p>
 * <b>NOTE</b>: 이 서비스를 통해 어플리케이션에서 UUID, DB에 저장된 값을 이용한
 * 유일키를 제공 받을 수 있다.
 * @author 실행환경 개발팀 김태호
 * @since 2009.02.01
 * @version 1.0
 ...
 * </pre>
 */
public interface SpringIdGnrService {
    Log LOGGER = LogFactory.getLog(SpringIdGnrService.class);
     ...
     *         유효한 String Id의 범위를 벗어 났을 경우
     */
    String getNextStringId(SpringIdGnrStrategy strategy) throws FdlException;
}