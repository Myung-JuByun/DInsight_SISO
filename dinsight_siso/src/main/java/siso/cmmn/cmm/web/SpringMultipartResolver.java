 ...
 * </pre>
 */
public class SpringMultipartResolver extends CommonsMultipartResolver {
    public SpringMultipartResolver() {
    }
     ...
     */
    public SpringMultipartResolver(ServletContext servletContext) {
    ...
    protected MultipartParsingResult parseFileItems(List fileItems, String encoding) {
		...
		for (Iterator it = fileItems.iterator(); it.hasNext();) {
		    ...
		    if (fileItem.isFormField()) {
				...
				String contentType = mpParamContentTypes.get(fileItem.getFieldName());
	...
	MultipartParsingResult multipartParsingResult = new MultipartParsingResult(multipartFiles, multipartParameters,mpParamContentTypes);
