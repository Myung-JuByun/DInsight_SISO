...
import siso.cmmn.cmm.IncludedCompInfoVO;
import siso.cmmn.cmm.IncludedInfo;
import siso.cmmn.util.SpringUserDetailsHelper;
import siso.sys.service.LoginVO;


@Controller
public class SpringComIndexController implements ApplicationContextAware ,InitializingBean {

	private ApplicationContext applicationContext;

	protected static final Log LOG = LogFactory.getLog(SpringComIndexController.class);
	...
	public void setApplicationContext(ApplicationContext applicationContext)
		...
		LOG.info("SpringComIndexController setApplicationContext method has called!");
	}

	@RequestMapping("/index")
	public String index(ModelMap model){
		return "springboot/com/cmm/SpringUnitMain";
	}

	@RequestMapping("/springTop")
	public String top(){
		return "springboot/com/cmm/SpringUnitTop";
	}

	@RequestMapping("/springBottom")
	public String bottom(){
		return "springboot/com/cmm/SpringUnitBottom";
	}

	@RequestMapping("/springContent")
	public String setContent(ModelMap model){

		LoginVO loginVO = (LoginVO)SpringUserDetailsHelper.getAuthenticatedUser();
		model.addAttribute("loginVO", loginVO);

		return "springframework/com/cmm/SpringUnitContent";
	}


	@SuppressWarnings({ "rawtypes", "unchecked" })
	@RequestMapping("/springLeft")
	public String setLeftMenu(ModelMap model){
		...
		LOG.debug("SpringComIndexController index is called " );
		return "springframework/com/cmm/SpringUnitLeft";
	}
}
