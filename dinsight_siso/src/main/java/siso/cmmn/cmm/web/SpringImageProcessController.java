...
import siso.cmmn.util.SessionVO;
...
@Controller
public class SpringImageProcessController extends HttpServlet {

    @Autowired
    private SpringFileMngService fileService;

    private static final Logger LOG = Logger.getLogger(SpringImageProcessController.class.getName());
     ...
     * @throws Exception
     */
    @RequestMapping("/cmm/fms/getImage")
