...
public class SpringEhgtCalcUtil {
...
private class CallbackHandler extends HTMLEditorKit.ParserCallback	{
    ...
    public void handleText(char[] data, int pos)	{
    	...
    	String	srcStr = new String(data);
   	  	...
   	  	srcStr = SpringStringUtil.strip(srcStr," ");
	...
	public static	String  getEhgtCalc(String srcType, long srcAmount, String cnvrType) throws Exception {
        ...
        try	{
        	SpringEhgtCalcUtil parser = new SpringEhgtCalcUtil();
        	parser.readHtmlParsing("http://community.fxkeb.com/fxportal/jsp/RS/DEPLOY_EXRATE/4176_0.html");

        	if (sb == null)	throw new RuntimeException("StringBuffer is null!!");        	
        	eghtStdrRt = SpringStringUtil.split(sb.toString(),"/");
		} catch	(Exception e) {
		    //e.printStackTrace();
