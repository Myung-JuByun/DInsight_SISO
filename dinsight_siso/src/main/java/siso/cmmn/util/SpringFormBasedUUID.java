...
public class SpringFormBasedUUID implements Serializable {
    /*
     ...
     */
    private SpringFormBasedUUID(byte[] data) {
        long msb = 0;
        long lsb = 0;
        for (int i = 0; i < 8; i++)
     ...
     * @param leastSigBits
     */
    public SpringFormBasedUUID(long mostSigBits, long leastSigBits) {
     ...
     */
    public static SpringFormBasedUUID randomUUID() {
        ...
        return new SpringFormBasedUUID(randomBytes);
    }
     ...
     */
    public static SpringFormBasedUUID nameUUIDFromBytes(byte[] name) {
        MessageDigest md;
        try {
        ...
        return new SpringFormBasedUUID(md5Bytes);
    }
     ...
     */
    public static SpringFormBasedUUID fromString(String name) {
        ...
        return new SpringFormBasedUUID(mostSigBits, leastSigBits);
    }
    ...
    public boolean equals(Object obj) {
    	...
    	if (!(obj instanceof SpringFormBasedUUID))
            return false;
        if (((SpringFormBasedUUID) obj).variant() != this.variant())
            return false;
        SpringFormBasedUUID id = (SpringFormBasedUUID) obj;
     ...
     */
    public int compareTo(SpringFormBasedUUID val) {
