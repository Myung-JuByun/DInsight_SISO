 ...
 * </pre>
 */
public class SpringNumberCheckUtil {
	...
	public static boolean checkJuminNumber(String jumin1, String jumin2) {    	
    	SpringDateUtil egovDateUtil = new SpringDateUtil();
	...
	public static boolean checkforeignNumber( String foreign1, String foreign2  ) {     	
		...
		if ( check % 11 == 0 ) 	check = 1; 
		else if ( check % 11==10 ) check = 0; 
		else check = check % 11; 

		if ( check + 2 > 9 )	check = check + 2- 10; 
