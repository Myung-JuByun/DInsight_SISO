function mkSearchDiv(){
	...
	cf.setCss(searchCompany,{width:"130px"});
	cf.setCss(span,{paddingRight:"5px"});
	cf.setCss(bx2,{width:"210px"});//paddingLeft:21+"px"
	...
	cf.setCss(searchContract,{width:"130px"});
	cf.setCss(span,{paddingRight:"5px"});
	cf.setCss(bx3,{paddingLeft:"35px",width:"240px"});
	...
	cf.setCss(bx5,{float:"left",paddingLeft:"20px"});
	mkBtnDiv();
};
