		...
		obj.trav(function(d,i){
			...
			if(d.quote_file_name != '' && d.quote_file_name != null && d.quote_file_name != undefined){
				...
				aTagImg.onclick = function(){
					window.open(encodeURI("/sas/quote/quoteDownloadAjax?sh_quote_id=" + d.quote_id));
				}
			}
...
function quoteDetailPop(str,obj){
	...
	Object.assign(con.style, {width:"900px", height:"450px", position:"absolute"});
	con.innerHTML="";
	
	var con0=cf.mkTag("div",con),	
		con1=cf.mkTag("div",con0);	
	Object.assign(con1.style, {width:"900px", height:"450px", border:"2px solid black", backgroundColor:"white"});
...
function quotePop(opt,data){
	var con=document.createElement("div");
	Object.assign(con.style, {width:"450px", height:(!opt)?"237px":"269px", position:"absolute"});
	...
	Object.assign(con1.style, {width:"450px", height:(!opt)?"237px":"269px", border:"2px solid black", backgroundColor:"white"});
...
function mkModiTable(son,data){
	...
	aTagImg.src = "/images/ico/ico_filedown.gif";
	aTagImg.onclick = function(){
		window.open(encodeURI("/sas/quote/quoteDownloadAjax?sh_quote_id=" + data.quote_id));
	}
