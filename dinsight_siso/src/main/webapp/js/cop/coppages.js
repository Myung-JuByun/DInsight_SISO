...
function mkDiv_srch(p){
	...
	cf.setCss(bx2,{float:"left",paddingLeft:20+"px"});
};
...
function mkList_head(p){
	...
	cf.setCss(th1,{width:119+"px"});
	cf.setCss(th4,{width:109+"px"});
	cf.setCss(th7,{width:119+"px"});
	cf.setCss(th8,{width:119+"px"});
	cf.setCss(th9,{width:119+"px"});
	//cf.setCss(th10,{width:49+"px"});
	cf.setCss(th11,{width:109+"px"});
	//cf.setCss(th12,{width:109+"px"});
	cf.setCss(th15,{width:44+"px"});
	cf.setCss(th16,{width:44+"px"});
	cf.setCss(th17,{width:109+"px"});
...
function mkList_body(p,data){
	...
	function commonstyle(row,i,col,j){
		...
		if(j==0)cf.setCss(col,{width:119+"px"});
		if(j==3)cf.setCss(col,{width:109+"px"});
		else if(j==6)cf.setCss(col,{width:119+"px"});
		else if(j==7)cf.setCss(col,{width:119+"px"});		
		else if(j==8)cf.setCss(col,{width:119+"px"});
		else if(j==10)cf.setCss(col,{width:109+"px"});
		else if(j==12)cf.setCss(col,{textAlign:"left",paddingLeft:10+"px"});
		else if(j==14 || j==15)cf.setCss(col,{width:44+"px"});
		else if(j==26)cf.setCss(col,{width:109+"px"});
	...
	if(j==0||j==1){
		...
		if(txt){
			...
			img.onclick=function(){
				javascript:window.open(encodeURI("/cop/companyDownloadAjax.do?sh_company_id=" +data[i][18]));
			};
