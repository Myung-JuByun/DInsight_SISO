function mkSearch(){
	...
	cf.setCss(span1,{paddingRight:"12px",fontWeight:"bold"});
	cf.setCss(span2,{paddingRight:"12px",marginLeft:"5px"});
	cf.setCss(bx1,{width:"357px"});
	...
	bx3.id = "weekDate";
	cf.setCss(bx3,{paddingLeft:"12px",paddingTop:"5px"});
...
function approvalList(data){
	...
	cf.setCss(dv,{height:cf.workareaheight-225+"px",minHeight:"630px",overflowY:"scroll",overflowX:"hidden"});
	
	var con=document.createElement("div");
	Object.assign(con.style, {width:"820px", height:(cf.workareaheight-170)+"px", position:"absolute", backgroundColor:"white"});
