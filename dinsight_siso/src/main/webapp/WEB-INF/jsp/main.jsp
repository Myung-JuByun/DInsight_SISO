...
<div id="Wrapper">
	...
	<div id="Main_wrap">
		<c:if test="${loginVO != null}">
			<jsp:include page="cmm/top_layout.jsp" flush="true"></jsp:include>
		</c:if>
					...
					<c:choose>
						<c:when test="${result.chkMenu eq 'Y'}">
							<div class="em">
								...
								<img src="<c:url value='/images/main/main_em.png'/>" alt="<c:out value='${result.menu_name}'/>" /></a>
							</div>
						</c:when>
		   				<c:otherwise>
		   					<div class="em">
				...
				<c:when test="${result.menu_img_url eq '/images/main/right_05.gif'}">
					<c:choose>
						<c:when test="${result.chkMenu eq 'Y'}">
							<div class="cr">
								<a href="javascript:fn_pageMove('<c:out value='${result.menu_id}'/>','<c:out value='${result.menu_url}'/>')">
									<img src="<c:url value='/images/main/main_cr.png'/>" alt="<c:out value='${result.menu_name}'/>" />
								</a>
							</div>
						</c:when>
		   				<c:otherwise>
				...
				<c:when test="${result.menu_img_url eq '/images/main/right_06.gif'}">
					<c:choose>
						<c:when test="${result.chkMenu eq 'Y'}">
							<div class="cr2">
								<a href="javascript:fn_pageMove('<c:out value='${result.menu_id}'/>','<c:out value='${result.menu_url}'/>')">
									<img src="<c:url value='/images/main/main_sm.png'/>" alt="<c:out value='${result.menu_name}'/>" />
								</a>
							</div>
						</c:when>
		   				<c:otherwise>
				...
				<c:when test="${result.menu_img_url eq '/images/main/right_04.gif'}">
					<c:choose>
						<c:when test="${result.chkMenu eq 'Y'}">
							<div class="cm">
								<a href="javascript:fn_pageMove('<c:out value='${result.menu_id}'/>','<c:out value='${result.menu_url}'/>')">
									<img src="<c:url value='/images/main/main_cm.png'/>" alt="<c:out value='${result.menu_name}'/>" />
								</a>
							</div>
						</c:when>
		   				<c:otherwise>
				...
				<c:when test="${result.menu_img_url eq '/images/main/right_03.gif'}">
					<c:choose>
						<c:when test="${result.chkMenu eq 'Y'}">
							<div class="pm">
								<a href="javascript:fn_pageMove('<c:out value='${result.menu_id}'/>','<c:out value='${result.menu_url}'/>')">
									<img src="<c:url value='/images/main/main_pm.png'/>" alt="<c:out value='${result.menu_name}'/>" />
								</a>
							</div>
						</c:when>
		   				<c:otherwise>
				...
				<c:when test="${result.menu_img_url eq '/images/main/right_10.gif'}">
					<c:choose>
						<c:when test="${result.chkMenu eq 'Y'}">
							<div class="alc">
								<a href="javascript:fn_pageMove('<c:out value='${result.menu_id}'/>','<c:out value='${result.menu_url}'/>')">
									<img src="<c:url value='/images/main/main_alc.png'/>" alt="<c:out value='${result.menu_name}'/>" />
								</a>
							</div>
						</c:when>
		   				<c:otherwise>
				...
				<c:when test="${result.menu_img_url eq '/images/main/right_11.gif'}">
					<c:choose>
						<c:when test="${result.chkMenu eq 'Y'}">
							<div class="pm2">
								<a href="javascript:fn_pageMove('<c:out value='${result.menu_id}'/>','<c:out value='${result.menu_url}'/>')">
									<img src="<c:url value='/images/main/main_pm2.png'/>" alt="<c:out value='${result.menu_name}'/>" />
								</a>
							</div>
						</c:when>
		   				<c:otherwise>
		...
		<div class="main_title">
			<img src="/images/main/main_title.png" alt="인트라넷시스템" />
		</div>
	</div>

	<!-- Rignt menu start-->
	<div id="Right_wrap">
		<a href="javascript:void(0)" style="cursor: default"><img src="/images/main/right_00.gif" alt="전체메뉴보기" /></a>
		<ul>
			<c:forEach var="result" items="${menuInfo.mainMenu}" varStatus="status">
				<c:choose>
...
<!-- popup start-->
<jsp:include page="login_pop.jsp"></jsp:include>
<!-- popup end-->
</body>
</html>