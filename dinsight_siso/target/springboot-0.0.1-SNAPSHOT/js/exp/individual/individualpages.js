...
function defaultAutoCompleteResult(json) {
	...
	for (mainCnt = 1; mainCnt <= 12; mainCnt++) {
		...
		if(arr_status_cd[mainCntView]=="701"){
			HTML += "<td class='txt_center right'><img src='/images/exp_payment/btn_red.png' align='absmiddle'/> " + convertNull(arr_status[mainCntView]) + "</td>";
		}else if(arr_status_cd[mainCntView]=="702"){
			HTML += "<td class='txt_center right'><img src='/images/exp_payment/btn_blue.png' align='absmiddle'/> " + convertNull(arr_status[mainCntView]) + "</td>";
		}else if(arr_status_cd[mainCntView]=="703"){
			HTML += "<td class='txt_center right'><img src='/images/exp_payment/btn_green.png' align='absmiddle'/> " + convertNull(arr_status[mainCntView]) + "</td>";
		}else if(arr_status_cd[mainCntView]=="706"){
			HTML += "<td class='txt_center right'><img src='/images/exp_payment/btn_yellow.gif' align='absmiddle'/> " + convertNull(arr_status[mainCntView]) + "</td>";
		}else {
